...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Tools for and by Church Army's Research Unit",
    Description = "Church Army colours and themes, plus miscelanous helpers.",
    `Authors@R` = c(person("Dave", "Lovell", email = "david.lovell@churcharmy.org", role = c("aut", "cre")))
    ))
...
fusen::init_share_on_github(organisation = "Church-Army")
```
...
# Code of Conduct
usethis::use_code_of_conduct("ask@churcharmy.org")
# NEWS
usethis::use_news_md()
